...
# a = begin testing comments ... public facing interface methods(s): :play (only) ... paths for testing: "Happy" and "Sad" paths ... I don't know how to do this when this method only calls other methods ...Question: Confirm: are private methods never tested? Why not? Why should one not test for logical errors? 
# private methods: set_up, welcome, setup_deck, setup_board, setup_participants, etc., see below for others.
